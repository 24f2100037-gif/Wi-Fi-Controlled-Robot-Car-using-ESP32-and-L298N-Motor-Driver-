Wi-Fi Controlled Robot Car using ESP32 and L298N Motor Driver                                       		
                                                    by Harsh Rathee 
...
Hosts a web server with an interface.

Detects user commands (/forward, /backward, etc.).

Controls the motors based on received commands.
